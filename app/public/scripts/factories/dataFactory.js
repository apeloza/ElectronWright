...
function getCaseNum(){
  return casenum;
    ...
    function getChars() {
        var promise = $http.get('../assets/json/case' + casenum + '/characters.json').then(function(response) {
    ...
    function getScenes() {
        var promise = $http.get('../assets/json/case' + casenum + '/scenes.json').then(function(response) {
            console.log('Async data returned: ', response.data);
...
function sceneOrder(){
  return scenes.sceneArray;
    ...
    function getEvidence() {
        var promise = $http.get('../assets/json/case' + casenum + '/evidence.json').then(function(response) {
            console.log('Async data returned: ', response.data);
